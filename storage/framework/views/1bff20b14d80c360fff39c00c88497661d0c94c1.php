    ...
    <div class="<?php echo e($auth_type ?? 'login'); ?>-box">
        ...
        <div class="<?php echo e($auth_type ?? 'login'); ?>-logo">
            <a href="<?php echo e($dashboard_url); ?>">
                ...
                <?php echo config('adminlte.logo', '<b>Monitoring</b>Sensor'); ?>
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\v2\resources\views/vendor/adminlte/auth/auth-page.blade.php ENDPATH**/ ?>